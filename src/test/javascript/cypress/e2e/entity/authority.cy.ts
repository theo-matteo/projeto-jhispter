...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '4b97a753-9794-4575-9429-049d60006d38' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('24aa7c8a-9e2b-4721-a4ec-aded42669e52');
      cy.get(`[data-cy="name"]`).should('have.value', '24aa7c8a-9e2b-4721-a4ec-aded42669e52');
