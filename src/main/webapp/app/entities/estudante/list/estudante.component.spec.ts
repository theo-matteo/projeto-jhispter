...
import { sampleWithRequiredData } from '../estudante.test-samples';
...
describe('Estudante Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EstudanteComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.estudantes()[0]).toEqual(expect.objectContaining({ id: 19416 }));
  });

  describe('trackId', () => {
    it('Should forward to estudanteService', () => {
      const entity = { id: 19416 };
      jest.spyOn(service, 'getEstudanteIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEstudanteIdentifier).toHaveBeenCalledWith(entity);
